  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 flex items-center justify-center">
      <div className="text-center px-6">
        ...
        <h1 className="text-xl font-light text-gray-900 dark:text-white tracking-wide mb-2">{t("common.somethingWentWrong")}</h1>
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-8">{t("common.unexpectedError")}</p>
