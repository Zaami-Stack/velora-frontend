  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div>
        ...
        <p className="text-xs sm:text-sm text-gray-400 mt-1">All registered users and their purchase history</p>
      </div>

      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
        <div className="bg-white/[0.03] rounded-xl sm:rounded-2xl p-3 sm:p-5 border border-white/5">
          <p className="text-[10px] sm:text-xs font-medium text-gray-500 uppercase tracking-wider mb-1.5 sm:mb-2">Total Users</p>
      ...
      <div className="bg-white/[0.03] rounded-xl sm:rounded-2xl border border-white/5 overflow-hidden">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-white/5">
                ...
                <th className="text-left text-[11px] font-medium text-gray-500 uppercase tracking-wider px-6 py-3">Phone</th>
                <th className="text-left text-[11px] font-medium text-gray-500 uppercase tracking-wider px-6 py-3">Joined</th>
                <th className="text-left text-[11px] font-medium text-gray-500 uppercase tracking-wider px-6 py-3">Orders</th>
                <th className="text-left text-[11px] font-medium text-gray-500 uppercase tracking-wider px-6 py-3">Total Spent</th>
                <th className="text-left text-[11px] font-medium text-gray-500 uppercase tracking-wider px-6 py-3">Role</th>
              </tr>
            </thead>
            <tbody>
              {users.length === 0 ? (
        ...
        <div className="sm:hidden divide-y divide-white/5">
          {users.length === 0 ? (
            <p className="px-4 py-12 text-center text-xs text-gray-500">No users found</p>
          ) : users.map((u) => (
