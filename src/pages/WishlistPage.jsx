    ...
    <Layout hideSideNav>
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-8">
        <div className="flex items-center justify-between mb-6 md:mb-10 gap-3">
          <h1 className="text-xl md:text-2xl font-light text-gray-900 dark:text-white tracking-wide">Wishlist ({items.length})</h1>
          {items.length > 0 && (
        ...
        {items.length === 0 ? (
          <div className="text-center py-24">
            ...
            <p className="text-gray-400 dark:text-gray-500 text-sm mb-6">Your wishlist is empty</p>
            ...
            {items.map((item) => (
              <div key={item.id} className="group relative">
                ...
                <div className="mt-3 px-0.5">
                  ...
                  <button onClick={() => { toggle(item); toast.info("Removed from wishlist"); }}
