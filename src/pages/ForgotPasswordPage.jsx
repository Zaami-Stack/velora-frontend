...
export default function ForgotPasswordPage() {
  ...
  const handleResetSubmit = async (e) => {
    e.preventDefault();
    const errs = {};
    if (!answer.trim()) errs.answer = "Please provide your answer";
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          {step === "email" && (
            <div className="mt-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white tracking-tight mb-2">Reset your password</h2>
              ...
              <form onSubmit={handleEmailSubmit} className="space-y-5" noValidate>
                <div>
                  ...
                  <input id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@example.com" autoFocus className={inputClass("email")} />
          ...
          {step === "question" && (
            <div className="mt-8">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight mb-2">Security Question</h2>
              ...
              <div className="mb-6 p-4 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl">
                <p className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Your question</p>
              ...
              <form onSubmit={handleResetSubmit} className="space-y-5" noValidate>
                <div>
                  <label htmlFor="answer" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Your answer</label>
                  <input id="answer" type="text" value={answer} onChange={(e) => setAnswer(e.target.value)} placeholder="Type your answer..." autoFocus className={inputClass("answer")} />
                  {errors.answer && <p className="text-xs text-red-500 mt-1">{errors.answer}</p>}
                </div>

                <div>
                  <label htmlFor="newPassword" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">New password</label>
                  <div className="relative">
                    <input id="newPassword" type={showPassword ? "text" : "password"} value={newPassword} onChange={(e) => setNewPassword(e.target.value)} placeholder="Enter new password" className={`${inputClass("newPassword")} pr-12`} />
          ...
          {step === "success" && (
            <div className="mt-8">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight mb-2">Password reset complete</h2>
