      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-8">
        ...
        <div className="mt-12 md:mt-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              {reviews.length === 0 ? (
                <p className="text-sm text-gray-500 dark:text-gray-400">{t("reviewForm.noReviews")}</p>
              ) : (
                  ...
                  {reviews.map((rev) => (
                    <div key={rev.id} className="p-4 bg-gray-50 dark:bg-white/5 rounded-lg border border-gray-100 dark:border-white/5">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xs text-gray-500 dark:text-gray-400">{rev.customerName}</span>
                      </div>
            ...
            <div>
              {reviewSubmitted ? (
                ...
                <form onSubmit={handleReviewSubmit} className="space-y-4">
                  ...
                  <input type="text" value={reviewForm.name} onChange={(e) => setReviewForm({...reviewForm, name: e.target.value})} placeholder={t("reviewForm.name")} className="w-full px-3 py-2 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:border-gray-300 dark:focus:border-white/20" required />
                  <input type="email" value={reviewForm.email} onChange={(e) => setReviewForm({...reviewForm, email: e.target.value})} placeholder={t("reviewForm.emailField")} className="w-full px-3 py-2 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:border-gray-300 dark:focus:border-white/20" />
                  <div>
                    <p className="text-xs font-medium text-gray-600 dark:text-gray-400 mb-2">{t("reviewForm.rating")}</p>
                  ...
                  <input type="text" value={reviewForm.title} onChange={(e) => setReviewForm({...reviewForm, title: e.target.value})} placeholder={t("reviewForm.titlePlaceholder")} className="w-full px-3 py-2 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:border-gray-300 dark:focus:border-white/20" />
                  <textarea rows={3} value={reviewForm.comment} onChange={(e) => setReviewForm({...reviewForm, comment: e.target.value})} placeholder={t("reviewForm.commentPlaceholder")} className="w-full px-3 py-2 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:border-gray-300 dark:focus:border-white/20 resize-none" />
